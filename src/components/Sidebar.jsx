  ...
  return (
    <div>
      <div style={{ display: 'flex', alignItems: 'center', gap: 6, flexWrap: 'wrap' }}>
        ...
        {d.estimated && (
          <span className={styles.estimatedBadge}>AI Estimated</span>
        )}
      </div>
      ...
      {d.estimated && (
        <div className={styles.estimatedNote}>
          {d.nearestZip
            ? <>Based on nearest tracked ZIP <strong>{d.nearestZip}</strong> ({d.nearestCity}), {d.distanceKm} km away. Predictions generated by trained XGBoost models.</>
            : <>Data sourced from CalEnviroScreen 4.0. Risk scores predicted by trained XGBoost models.</>
          }
        </div>
      )}
