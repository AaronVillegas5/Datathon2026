"""
Generate src/data/predictedZips.js for all Melissa ZIP codes not in ZIPS.js (OC dataset).
Covers both:
...
asthma_model = load_model("Asthma/best_xgb_model.pkl")
cardio_model  = joblib.load("Cardiovascular/cardiovascular_model.pkl")
...
with open("src/data/zips.js") as f:
    raw = f.read()
...
out_path = "src/data/predictedZips.js"
